...
const echarts = [
  ...
  },
  {
    ...
    option: {
      backgroundColor: {
        colorStops: [
          { color: '#f7f8fa', offset: 0 },
          { color: '#cdd0d5', offset: 1 },
        ],
        global: false,
        r: 0.8,
        type: 'radial',
      ...
      legend: { data: ['1990', '2015'], right: 10 },
      series: [
        {
          data: [
          ...
          emphasis: { label: { position: 'top', show: true } },
          itemStyle: {
            color: {
              colorStops: [
                { color: 'rgb(251, 118, 123)', offset: 0 },
                { color: 'rgb(204, 46, 72)', offset: 1 },
              ],
              global: false,
              r: 1,
              type: 'radial',
        ...
        },
        {
          ...
          itemStyle: {
            color: {
              colorStops: [
                { color: 'rgb(129, 227, 238)', offset: 0 },
                { color: 'rgb(25, 183, 207)', offset: 1 },
              ],
              global: false,
              r: 1,
              type: 'radial',
